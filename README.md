...
| :---: | :--- | :---: | :---: | :--- |
| 0001 | [Detect a cycle in an undirected graph](./DSA/Graphs/detect-a-cycle-in-an-undirected-graph) | [BFS](./DSA/Graphs/detect-a-cycle-in-an-undirected-graph/BFS.cpp) [Solution-1](./DSA/Graphs/detect-a-cycle-in-an-undirected-graph/Solution-1.cpp) [DFS](./DSA/Graphs/detect-a-cycle-in-an-undirected-graph/DFS.cpp) | 🔴 Hard | `DSA` / `Graphs` |
